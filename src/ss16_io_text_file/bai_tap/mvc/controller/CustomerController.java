package ss16_io_text_file.bai_tap.mvc.controller;

import ss16_io_text_file.bai_tap.mvc.model.Customer;
import ss16_io_text_file.bai_tap.mvc.service.CustomerService;
...
public class CustomerController {
    ...
    private Customer inputDataForCustomer(String type) {
        int id = -1;
        if (type.equals("add")) {
            id = inputIdCustomer("Nhập ID khách hàng: ");
        }
        ...
        return new Customer(id, name, dob, address);
    }
